document.addEventListener('DOMContentLoaded', function() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    const whatsappUrl = `https://wa.me/6281234567890?text=Halo,%20saya%20${encodeURIComponent(data.nama)}%20sudah%20mengisi%20form%20franchise.%20Berikut%20detailnya:%0A%0AWhatsApp:%20${encodeURIComponent(data.whatsapp)}%0AKota:%20${encodeURIComponent(data.kota)}%0APertanyaan:%20${encodeURIComponent(data.pertanyaan || '-')}`;
